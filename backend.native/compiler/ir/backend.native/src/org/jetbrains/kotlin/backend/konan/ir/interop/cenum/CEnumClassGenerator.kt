...
internal class CEnumClassGenerator(
    ...
    private val cEnumVarClassGenerator = CEnumVarClassGenerator(irBuiltIns, symbolTable, typeTranslator, interopBuiltIns)
    ...
    private fun createValueProperty(irClass: IrClass): IrProperty {
        ...
        symbolTable.withScope(propertyDescriptor) {
            ...
            irProperty.getter = createOverridingFunction(
